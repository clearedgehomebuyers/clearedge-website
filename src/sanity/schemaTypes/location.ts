...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: 'Priority Seller Situations',
      type: 'array',
      of: [{ type: 'reference', to: [{ type: 'situation' }] }],
      description: 'The first three valid references appear on the location page. Put the most useful local seller journeys first.',
      group: 'enhanced',
    }),
  ],
  groups: [
