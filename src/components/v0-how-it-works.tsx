...
export function V0HowItWorks() {
  return (
    <section id="how-it-works" className="py-16 md:py-24 bg-[#f7faf7]">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative group">
              ...
              {index < steps.length - 1 && (
                <div className="hidden md:block absolute top-16 left-[calc(50%+60px)] w-[calc(100%-120px)] h-0.5 bg-[#00b332]/20">
                  <div className="absolute right-0 top-1/2 -translate-y-1/2 w-2 h-2 bg-[#00b332] rounded-full" />
                </div>
              )}

              <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#00b332]/10 hover:shadow-md hover:border-[#00b332]/30 transition-all h-full">
                {/* Step Number & Icon */}
                <div className="flex items-center gap-4 mb-6">
                  <span className="text-4xl font-serif font-medium text-[#00b332]/20">{step.number}</span>
                  <div className="w-12 h-12 rounded-xl bg-[#00b332]/10 flex items-center justify-center group-hover:bg-[#00b332]/20 transition-colors">
                    <step.icon className="w-6 h-6 text-[#00b332]" />
                  </div>
                </div>
                ...
                <span className="inline-flex items-center px-3 py-1 rounded-full bg-[#00b332]/10 text-[#00b332] text-sm font-medium">
                  {step.accent}
                </span>
              </div>
            </div>
