        ...
        <div className="flex justify-between items-center h-24">
          <Link href="/" className="flex items-center" aria-label="ClearEdge Home Buyers Primary Logo">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1634 560" className="w-[220px] h-auto block" aria-label="ClearEdge Home Buyers">
              ...
              <path fill="#008a29" d="M0 324.729c1.247-8.762 1.71-16.336 3.602-25.122 6.14-28.511 21.387-53.981 44.81-71.618 27.302-20.558 65.681-27.934 99.172-23.257 26.454 3.694 53.089 16.739 71.532 36.225-10.369 10.445-20.893 19.959-31.014 30.075-30.091-30.72-87.564-31.134-118.15-.907-31.667 31.296-32.357 90.638-.683 122.167 31.123 30.979 90.41 28.617 120.746-2.421q.245-.251.487-.505l32.093 32.191c-29.797 30.109-68.104 38.675-109.174 35.777-56.668-4-100.713-40.712-110.526-97.403-1.074-6.206-1.593-16.293-2.895-21.78z"/>
