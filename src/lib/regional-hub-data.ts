...
export const nepaHubData: RegionalHubData = {
  ...
  metaTitle: 'Sell Your NEPA House Fast for Cash | ClearEdge',
  metaDescription: "Cash home buyer across Northeast Pennsylvania \u2014 Scranton, Wilkes-Barre, Hazleton and surrounding counties. No repairs, no fees. Fair offer in 24 hours.",
  overviewContent: [
...
export const poconosHubData: RegionalHubData = {
  ...
  metaTitle: 'Sell Your Poconos Property Fast for Cash | ClearEdge',
  metaDescription: "Cabins, A-frames, lakefront homes, vacation properties \u2014 ClearEdge buys Poconos real estate as-is for cash. No repairs, no fees. Close in 7\u201330 days.",
  overviewContent: [
