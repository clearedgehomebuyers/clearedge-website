          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="lg:pl-4">
              <div className="bg-white rounded-3xl shadow-2xl p-8 border border-slate-100">
                <div className="mb-6">
                  <h2 className="text-2xl font-bold text-slate-800 mb-1">Get Your Cash Offer Today</h2>
      ...
      <footer className="bg-slate-900 text-white py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              <h4 className="font-bold mb-4 text-lg">Situations</h4>
              <ul className="space-y-3 text-slate-400">
                <li className="hover:text-white cursor-pointer transition-colors">Inherited Property</li>
                <li className="hover:text-white cursor-pointer transition-colors">Foreclosure</li>
                <li className="hover:text-white cursor-pointer transition-colors">Divorce</li>
                <li className="hover:text-white cursor-pointer transition-colors">All Situations</li>
              </ul>
            </div>
