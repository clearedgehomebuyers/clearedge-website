...
export const metadata: Metadata = {
  ...
  description: 'How ClearEdge buys PA houses for cash: tell us about your property, get a fair offer in 24 hours, close in 7\u201330 days. No repairs, no fees, no commissions.',
