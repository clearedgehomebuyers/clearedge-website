        ...
        <section className="py-4 md:py-6 bg-gradient-to-b from-[#f5f7f5] to-[#f0f4f1]">
          <div className="max-w-3xl mx-auto px-6 text-center">
            <p className="text-[#1a2e1a] font-medium">
              Not sure if a cash offer is right for you? Get a no-obligation offer from ClearEdge — use it as your benchmark. It costs nothing, there&apos;s no commitment, and we&apos;ll walk you through every line of the calculation.
            </p>
          </div>
        </section>
