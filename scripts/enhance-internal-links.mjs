...
const situationBlogs = {
  ...
  'tax-liens-code-violations': ['sell-house-wilkes-barre-code-violations', 'sell-house-tax-lien-bethlehem-pa', 'how-to-stop-berks-county-judicial-sale-2026'],
...
const locationBlogs = {
  ...
  'allentown': ['selling-water-damaged-house-18102-mold-issues', 'sell-my-house-fast-lehigh-valley'],
  'bethlehem': ['selling-house-international-property-maintenance-code-violations-bethlehem', 'sell-house-tax-lien-bethlehem-pa', 'sell-my-house-fast-lehigh-valley'],
...
const blogSituations = {
  ...
  'sell-house-tax-lien-bethlehem-pa': ['tax-liens-code-violations', 'foreclosure'],
...
const blogLocations = {
  ...
  'sell-house-tax-lien-bethlehem-pa': ['bethlehem'],
