...
function replaceRegionalContent(content) {
  ...
  const replacements = {
    ...
    step1: rich('step1', 'normal', [
      ...
      { text: ' Call {{phone}} or fill out the form. Tell us about the property and your situation; there is no obligation to accept an offer.' },
    ]),
    ...
    close3: p('close3', 'Call {{phone}} or fill out the form for a no-obligation cash offer. We will review the property and explain the next step so you can compare the offer with your other options.'),
  }
...
const regionalLooksDone = regional
  ...
  && regional.content.some((block) => block?._key === 'step1'
    && blockText(block) === 'Step 1: Contact us. Call {{phone}} or fill out the form. Tell us about the property and your situation; there is no obligation to accept an offer.')
  && regional.content.some((block) => block?._key === 'close3'
    && blockText(block) === 'Call {{phone}} or fill out the form for a no-obligation cash offer. We will review the property and explain the next step so you can compare the offer with your other options.')
...
if (!(afterRegional?.content || []).some((block) => block?._key === 'step1'
  && blockText(block) === 'Step 1: Contact us. Call {{phone}} or fill out the form. Tell us about the property and your situation; there is no obligation to accept an offer.')) verificationErrors.push('regional.step1Phone')
if (!(afterRegional?.content || []).some((block) => block?._key === 'close3'
  && blockText(block) === 'Call {{phone}} or fill out the form for a no-obligation cash offer. We will review the property and explain the next step so you can compare the offer with your other options.')) verificationErrors.push('regional.close3Phone')
